...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MaxLengthOnNames
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MaxLengthOnNames))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201602160507221_MaxLengthOnNames"
            End Get
        End Property
