...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DepartmentRowVersion
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DepartmentRowVersion))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201602181844054_DepartmentRowVersion"
            End Get
        End Property
