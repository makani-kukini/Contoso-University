...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DepartmentSP
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DepartmentSP))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201602181756305_DepartmentSP"
            End Get
        End Property
